...
<head>
	...
	<link rel="stylesheet" href="css/paquete-inicial/paquetes.css">
	<link rel="stylesheet" href="css/paquete-inicial/modal.css">
	<link rel="stylesheet" href="https://unpkg.com/swiper/swiper-bundle.min.css"/> <!-- CSS DEL SLIDER -->
	<link rel="stylesheet" href="css/paquete-inicial/slider-paquete-inicial.css"> <!-- CSS DEL SLIDER -->
...
<body>
	...
	<div class="container-principal">
		...
		<div class="container-descripcion-paquetes" data-aos="fade-up" data-aos-duration="1500">
			<div class="descripcion-paquetes">
				<div class="titulo-slider">PACK &nbsp<span class="colorear-titulos-slider">INICIAL</span></div>		
				<div class="parrafo-1-descripcion">
					<p>¡Estás más cerca de tener tu propia landing page!</p>
				</div>
				<div class="parrafo-2-descripcion">
					<p>Te brindamos una landing page sencilla, práctica y adaptable a cualquier dispositivo para que tus clientes puedan contactarte. Así, podrás centralizar las consultas que te llegan a través de un e-mail personalizado.</p>
				</div>
				...
				<div class="slider">
					...
					<div class="swiper-container mySwiper">
					  <div class="swiper-wrapper">
					  	<div class="swiper-slide"><img src="Imagenes/pack-inicial/Landing 3 -  300px.png" alt="" id="img1"></div>
					  	<div class="swiper-slide"><img src="Imagenes/pack-inicial/Landing 1 -  300px.png" alt="" id="img2"></div>
					  	<div class="swiper-slide"><img src="Imagenes/pack-inicial/Landing 4 -  300px.png" alt="" id="img3"></div>
					  	<div class="swiper-slide"><img src="Imagenes/pack-inicial/Landing 2 -  300px.png" alt="" id="img4"></div>
					  	<div class="swiper-slide"><img src="Imagenes/pack-inicial/Landing 5 -  300px.png" alt="" id="img5"></div>
					  	<div class="swiper-slide"><img src="Imagenes/pack-inicial/Landing 6 -  300px.png" alt="" id="img6"></div>
					  </div>
		...
		<div class="container-slider-sm" data-aos="fade-up" data-aos-duration="1500">
			...
			<div class="slider">
				...
				<div class="swiper-container mySwiper">
				  <div class="swiper-wrapper">
				    <div class="swiper-slide"><img src="Imagenes/pack-inicial/Landing 3 -  300px.png" alt=""></div>
				    <div class="swiper-slide"><img src="Imagenes/pack-inicial/Landing 1 -  300px.png" alt=""></div>
				    <div class="swiper-slide"><img src="Imagenes/pack-inicial/Landing 4 -  300px.png" alt=""></div>
				    <div class="swiper-slide"><img src="Imagenes/pack-inicial/Landing 2 -  300px.png" alt=""></div>
				    <div class="swiper-slide"><img src="Imagenes/pack-inicial/Landing 5 -  300px.png" alt=""></div>
				    <div class="swiper-slide"><img src="Imagenes/pack-inicial/Landing 6 -  300px.png" alt=""></div>
				  </div>
				  <div class="swiper-button-next flechas"></div>
				  <div class="swiper-button-prev flechas"></div>
				</div>
			...
			<div class="titulo-principal-preguntas">PREGUNTAS &nbsp<span class="colorear-titulos-slider">FRECUENTES</span></div>
				<div class="listado-preguntas">
					...
					<div class="pregunta">
						...
						<div class="respuesta" id="respuesta">
						Es una galería de imágenes cuyo contenido no cambiará, es decir, no es posible editar constantemente las imágenes seleccionadas. Además; una galería estática no cuenta con animaciones.
						</div>
					</div>
					<div class="pregunta">
						<div class="container-titulo-pregunta">
	...
	<script src="js/paquete-inicial/slider-paquete-inicial.js"></script>
	<script src="js/paquete-inicial/modal.js"></script>
