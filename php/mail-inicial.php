			...
			if(strlen($telefono) >= 10 ){
				...
				if(filter_var($consulta, FILTER_SANITIZE_STRING)){
					...
					/*	MAIL PARA EL USUARIO*/
						    ...
						    $mail->Body    = '¡Hola '.$nombre.'!<br><br>Revisaremos tu consulta por nuestro Paquete Inicial. A la brevedad te enviaremos una respuesta.<br>Nuestro tiempo de respuesta es de hasta un día hábil. Recordá que en caso de que necesites hacernos una consulta urgente podés escribirnos vía Whatsapp al siguiente número:<a href="https://wa.me/+5493517462682">+5493517462682</a>.<br><br>Saludos.<br><img src="https://new-input.com/Imagenes/FirmaNewinput.png">';
						    $mail->send();
					...
					/*	MAIL DE USO INTERNO*/	
						    ...
						    $mail2->Subject = 'Nueva consulta - Paquete Inicial';
